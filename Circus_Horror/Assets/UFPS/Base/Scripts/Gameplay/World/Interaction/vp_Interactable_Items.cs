...
public class vp_Interactable_Items : vp_Interactable
{
	VoiceScript voiceScript;
	vp_Interactable_Canon canonScript;

	public bool isCannonball;
	public bool isGunpowder;
	public bool isFuse;
	...
	public override bool TryInteract(vp_FPPlayerEventHandler player)
	{
		...
		{
			Destroy(gameObject);
			m_Player.HUDText.Send("You got the Cannon Ball");
			canonScript.gotCanonball = true;
		...
		{
			Destroy(gameObject);
			m_Player.HUDText.Send("You got the Gun Powder");
			canonScript.gotKeg = true;
		...
		{
			Destroy(gameObject);
			m_Player.HUDText.Send("You got the Fuse");
			canonScript.gotFuse = true;
